<a href="https://www.hipuku.dev"><img src="assets/banner.png" alt="hipuku" width="100%"></a>

<p align="center">
Software engineer in Sydney, working on design systems, testing and the tools around them,<br>
...
<a href="https://github.com/hipuku/haus"><img src="assets/haus.png" alt="haus"></a>
<p>A token-first React design system: W3C DTCG tokens in OKLCH, 20 accessible components and five packages on npm.</p>
...
<td width="50%" valign="top">
<a href="https://github.com/hipuku/drift"><img src="assets/drift.png" alt="drift"></a>
<p>Crawls a website and reports the design values it ships, deduplicated with CIEDE2000 and attributed to the pages that use them. Its HTTP API is covered by a black-box BDD suite.</p>
...
<tr>
<td width="50%" valign="top">
<a href="https://github.com/hipuku/core"><img src="assets/core.png" alt="core"></a>
<p>A team decision log: ADRs with a permission-gated lifecycle, two audit trails, and GitHub citations that report when the cited code changes.</p>
...
<td width="50%" valign="top">
<a href="https://github.com/hipuku/vault"><img src="assets/vault.png" alt="vault"></a>
<p>An offline Mac app for colours, fonts, palettes and type scales. Electron, React and SQLite, with a typed IPC boundary.</p>
...
<tr>
<td width="50%" valign="top">
<a href="https://tokenise.hipuku.dev"><img src="assets/tokenise.png" alt="tokenise"></a>
<p>Converts design tokens between DTCG, Figma variables, Tokens Studio and Tailwind v4, and reports every token each format changes or drops.</p>
<a href="https://tokenise.hipuku.dev">Open</a> · <a href="https://github.com/hipuku/tokenise">Source</a>
</td>
<td width="50%" valign="top">
<a href="https://specifi.hipuku.dev"><img src="assets/specifi.png" alt="specifi"></a>
<p>CSS specificity, token by token, on a from-scratch Selectors Level 4 parser.</p>
<a href="https://specifi.hipuku.dev">Open</a> · <a href="https://github.com/hipuku/specifi">Source</a>
</td>
</tr>
<tr>
<td width="50%" valign="top">
<a href="https://hexicon.hipuku.dev"><img src="assets/hexicon.png" alt="hexicon"></a>
<p>Names any hex by CIEDE2000, maps a palette in OKLCH and draws a WCAG contrast matrix for every pair.</p>
<a href="https://hexicon.hipuku.dev">Open</a> · <a href="https://github.com/hipuku/hexicon">Source</a>
</td>
<td width="50%" valign="top">
<a href="https://gray-scott.hipuku.dev"><img src="assets/gray-scott.png" alt="gray-scott"></a>
<p>Real-time Gray-Scott reaction-diffusion, simulated in a Web Worker.</p>
...
<table>
<tr>
<td valign="top"><sub>Physics</sub><br>Cloth pluck<br>Flocking<br>Shape pit<br>Spring drag</td>
<td valign="top"><sub>Canvas</sub><br>Flow field<br>Iron filings<br>Ripple grid</td>
<td valign="top"><sub>Type</sub><br>Text pressure<br>Text scramble<br>Velocity marquee</td>
<td valign="top"><sub>GSAP</sub><br>Card fan<br>MotionPath<br>Parallax tilt<br>Path editor</td>
<td valign="top"><sub>SVG</sub><br>Metaballs<br>Text loop</td>
</tr>
</table>
...
<td width="50%" valign="top">
<sub>Writing</sub>
<p><a href="https://www.hipuku.dev/writing/the-language-we-never-agreed-on">The Language We Never Agreed On</a><br>
<a href="https://www.hipuku.dev/writing/the-default-is-not-a-design-decision">The Default Is Not a Design Decision</a><br>
<a href="https://www.hipuku.dev/writing/motion-deserves-better-than-a-prop">Motion Deserves Better Than a Prop</a></p>
</td>
</tr>
</table>
